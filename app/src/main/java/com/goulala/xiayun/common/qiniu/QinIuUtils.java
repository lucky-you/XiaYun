package com.goulala.xiayun.common.qiniu;
...
public class QinIuUtils {
     ...
     */
    public static void qinIuUpLoad(String data, String key, String token, final QinIuUpLoadListener qinIuUpLoadListener) {
